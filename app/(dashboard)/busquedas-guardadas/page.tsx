        ...
        {confirmar ? (
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 py-2 text-xs font-semibold text-white bg-[#059669] hover:bg-[#047857] rounded-xl transition-colors flex items-center justify-center gap-1.5"
            >
...
const GrupoUsuario = ({
  ...
  return (
    <div className="mb-8">
      ...
      >
        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#059669] to-[#10B981] flex items-center justify-center text-white font-bold text-sm shadow-sm">
          {(nombre || email || '?')[0].toUpperCase()}
        </div>
        <div className="flex-1">
          <p className="font-bold text-slate-800 text-sm group-hover:text-[#059669] transition-colors">{nombre || '—'}</p>
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 bg-[#059669] hover:bg-[#047857] text-white rounded-xl text-sm font-semibold transition-colors"
        >
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4">
        <div className="flex flex-wrap gap-3 items-center">
          ...
          {/* Buscador de texto */}
          <div className="flex items-center gap-2 flex-1 min-w-[200px] border border-slate-200 rounded-xl px-3 focus-within:ring-2 focus-within:ring-[#059669]/20 bg-slate-50">
          ...
          {esAdmin && usuariosUnicos.length > 1 && (
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="text-xs border border-slate-200 rounded-xl px-3 py-2 bg-white outline-none focus:ring-2 focus:ring-[#059669]/20 text-slate-700"
              >
      ...
      {!cargando && !error && busquedas.length > 0 && busquedasFiltradas.length === 0 && (
        <div className="text-center py-16">
          ...
          <button
            ...
            className="mt-3 text-xs text-[#059669] hover:underline"
          >
            Limpiar filtros
          </button>
        </div>
