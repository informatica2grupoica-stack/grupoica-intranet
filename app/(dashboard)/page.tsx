    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center">
        <div className="relative mb-5">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#2563EB] to-[#3B82F6] flex items-center justify-center shadow-lg shadow-emerald-900/20">
  ...
  return (
    ...
    >
      ...
      <motion.div variants={fadeUp} transition={{ duration: 0.5 }} className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#111827] via-[#1E293B] to-[#111827] p-6 md:p-8 shadow-xl shadow-slate-900/20">
        ...
        <div className="absolute -bottom-24 -left-10 w-72 h-72 bg-[#2563EB]/10 blur-[100px] rounded-full pointer-events-none" />
        {mensajeHoy && (
          ...
          {mensajeHoy && (
            <div className="mt-6 pt-5 border-t border-white/8 animate-fade-in">
              <div className="flex items-start gap-4">
                ...
                <span className="text-5xl font-black text-[#3B82F6]/25 leading-none -mt-2 select-none shrink-0"
      ...
      <motion.div variants={fadeUp} className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        >
          ...
          <p className="text-[10px] text-[#2563EB] font-bold mt-1">pendientes</p>
          <ArrowRight className="w-4 h-4 text-slate-200 group-hover:text-[#2563EB] absolute top-5 right-5 transition-colors" />
        </div>
      ...
      <motion.div variants={fadeUp} className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-4">
            <span className="w-8 h-8 rounded-lg bg-emerald-100 text-[#2563EB] flex items-center justify-center flex-shrink-0">
            ...
            <button onClick={() => router.push("/tareas")} className="ml-auto text-[10px] text-[#2563EB] font-bold flex items-center gap-0.5 hover:underline">
              ...
              <div className="mt-4 space-y-2">
                {misTareas.slice(0, 3).map((t) => (
                  ...
                  >
                    ...
                    <Clock size={11} className="text-[#2563EB] opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0" />
                  </div>
                ))}
              </div>
            </>
      ...
      <motion.div variants={fadeUp} className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-[#2563EB] to-[#1D4ED8] p-4 text-white text-center shadow-md shadow-emerald-500/20">
          ...
          <div className="mt-5">
            ...
            <div className="h-2 bg-slate-100 rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-teal-500 to-[#2563EB] rounded-full transition-all duration-1000"
            ...
            <>
              <div className="grid grid-cols-3 gap-3">
                <div className="rounded-2xl border border-emerald-100 bg-emerald-50 p-4 text-center">
                  <TrendingDown className="w-5 h-5 text-[#2563EB] mx-auto mb-1" />
                  <p className="text-2xl font-black text-[#2563EB] tabular-nums"><AnimatedNumber value={historial.bajas} /></p>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Bar dataKey="value" radius={[6, 6, 0, 0]} animationBegin={400} animationDuration={900}>
                      {[{ fill: "#2563EB" }, { fill: "#EF4444" }, { fill: "#94A3B8" }].map((c, i) => (
      ...
      <motion.div variants={fadeUp} className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-100">
            <div className="bg-gradient-to-br from-[#2563EB] to-[#1D4ED8] rounded-xl p-3 text-white">
