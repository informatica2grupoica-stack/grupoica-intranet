    ...
    <div className="min-h-screen bg-[#F1F5F9] p-4 md:p-6 lg:p-12">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={refreshing}
              className="p-3 bg-white border border-slate-200 rounded-2xl text-slate-400 hover:text-[#4F46E5] transition-all shadow-sm disabled:opacity-50"
            ...
            <Link 
              href="/obuma-clientes" 
              className="p-3 bg-white border border-slate-200 rounded-2xl text-slate-400 hover:text-[#4F46E5] transition-all shadow-sm"
            >
              <ArrowLeft size={20} />
            </Link>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            <Users size={18} className="text-[#4F46E5] mb-1 group-hover:scale-110 transition-transform" />
                ...
                {contactos.length === 0 ? (
                  ...
                  contactos.map((c) => (
                    <div key={c.cc_id} className="p-3 bg-slate-50 rounded-xl">
                      ...
                      <p className="text-xs text-[#4F46E5] mt-1 break-all">{c.cc_email}</p>
