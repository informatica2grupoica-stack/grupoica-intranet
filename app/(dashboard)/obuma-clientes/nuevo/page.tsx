    ...
    <div className="min-h-screen bg-[#F1F5F9] p-4 md:p-6 lg:p-12">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <Link href="/obuma-clientes" className="p-3 bg-white border border-slate-200 rounded-2xl text-slate-400 hover:text-[#2563EB] transition-all shadow-sm">
            <ArrowLeft size={20} />
          </Link>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl md:rounded-[2.5rem] p-6 md:p-8 shadow-xl border border-slate-200 space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <input
                  type="text"
                  className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none focus:border-[#2563EB] focus:bg-white transition-all"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="number"
                    className="w-full pl-8 p-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none focus:border-[#2563EB] focus:bg-white transition-all"
                    placeholder="0"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="tel"
                    className="w-full pl-9 p-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none focus:border-[#2563EB] focus:bg-white transition-all"
          ...
          <div>
            ...
            <textarea
              className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none focus:border-[#2563EB] focus:bg-white transition-all resize-none"
              rows={3}
          ...
          <div className="flex justify-end gap-4 pt-4 border-t border-slate-100">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex items-center gap-2 px-8 py-3 bg-[#2563EB] text-white rounded-xl text-xs font-black uppercase shadow-lg hover:bg-blue-800 transition-all disabled:opacity-50"
            >
