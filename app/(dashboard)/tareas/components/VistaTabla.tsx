          ...
          <tbody className="divide-y divide-slate-50">
            {tareas.map((t) => {
              ...
              if (editandoTarea === t.id) {
                return (
                  <tr key={t.id} className="bg-[#EFF6FF]/30">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-end gap-2">
                          ...
                          <button
                            ...
                            className="px-4 py-2 bg-[#2563EB] text-white rounded-lg text-xs font-bold flex items-center gap-2"
                          >
              ...
              return (
                <tr key={t.id} className="group hover:bg-[#EFF6FF]/30 transition-colors relative">
                  <td className="px-6 py-4 cursor-pointer" onClick={() => onTaskClick(t.id)}>
                    <div className="font-bold text-slate-900 text-sm leading-tight group-hover:text-[#1D4ED8] transition-colors">
                      {t.titulo}
                    </div>
                    {t.proyecto && (
                      <div className="mt-1 inline-flex items-center gap-1 text-[9px] font-black text-[#2563EB] uppercase bg-[#EFF6FF] px-2 py-0.5 rounded-md italic">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-1.5">
                      <button 
                        ...
                        className="p-2 bg-white border border-slate-100 text-slate-400 hover:text-[#2563EB] hover:border-[#A7F3D0] rounded-xl transition-all relative"
                      >
                        ...
                        <>
                          {t.estado === 'pendiente' && (
                            <button 
                              ...
                              className="p-2 bg-[#2563EB] text-white hover:bg-slate-900 rounded-xl shadow-md transition-all" 
                              title="Iniciar"
                            >
                              <PlayCircle size={14} />
                            </button>
