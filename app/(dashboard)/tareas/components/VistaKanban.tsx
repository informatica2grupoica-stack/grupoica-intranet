      ...
      {columnas.map((col) => (
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <button
              className="w-full mt-2 p-2 border border-dashed border-slate-200 rounded-xl text-[9px] font-bold text-slate-400 hover:bg-white hover:border-[#A5B4FC] transition-all flex items-center justify-center gap-1"
            >
