        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex gap-2 ml-auto">
            ...
            <button onClick={exportar}
              className="px-4 py-2.5 text-xs font-bold bg-[#059669] text-white rounded-xl flex items-center gap-1.5">
                ...
                return (
                  <tr key={id||i} className="hover:bg-slate-50/50 transition-colors">
                    <td className="px-5 py-3.5">
                      ...
                      <span className="text-xs font-bold text-[#059669]">#{folio}</span>
                    </td>
