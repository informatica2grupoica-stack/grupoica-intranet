              ...
              {loadingLista ? (
                <tr>
                  <td colSpan={9} className="py-24 text-center">
                    <Loader2 className="w-10 h-10 animate-spin mx-auto text-[#2563EB] mb-2 opacity-20" />
                ...
                usuariosFiltrados.map(user => {
                  ...
                  return (
                    <tr key={user.id} className="hover:bg-[#EFF6FF]/30 transition-colors group">
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-3">
                          <div className={`w-9 h-9 rounded-full flex items-center justify-center text-slate-500 font-bold text-xs border border-white shadow-sm transition-all ${
                            esSuperUser ? "bg-[#111827] text-white" : "bg-slate-100 group-hover:bg-[#2563EB] group-hover:text-white"
                          }`}>
                          ...
                          <div>
                            <p className="font-bold text-slate-800 flex items-center gap-2 text-sm">
                              ...
                              {esSuperUser && <Lock className="w-3 h-3 text-blue-500" />}
                            </p>
                      ...
                      <td className="px-3 py-4 text-center">
                        <span className={`text-[9px] font-black px-2.5 py-1 rounded-full border ${
                          esSuperUser          ? "bg-[#EFF6FF] border-blue-100 text-[#2563EB]" :
                          user.rol === "admin" ? "bg-[#EFF6FF] border-[#EFF6FF] text-[#2563EB]" :
                      ...
                      <td className="px-3 py-4 text-center">
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-xl text-[9px] font-black transition-all ${
                            esSuperUser       ? "bg-[#EFF6FF] text-[#2563EB] cursor-default" :
                            user.activo
                      ...
                      <td className="px-5 py-4 text-right">
                        <div className="flex items-center justify-end gap-1">
                          {!esSuperUser && soyAdminOSuper ? (
                            <>
                              <button onClick={() => prepararEdicion(user)} className="p-2 text-slate-400 hover:text-[#2563EB] hover:bg-[#EFF6FF] rounded-xl transition-all" title="Editar">
            ...
            <form onSubmit={handleGuardarUsuario}>
              <div className="p-8 space-y-5 max-h-[62vh] overflow-y-auto">
                ...
                {tabActivo === "datos" && (
                  <>
                    {/* Datos personales */}
                    <div className="bg-[#EFF6FF]/30 rounded-2xl p-5 space-y-4">
                      <div className="flex items-center gap-2 mb-1">
                        <UserPlus className="w-4 h-4 text-[#2563EB]" />
                        <h3 className="text-xs font-black uppercase tracking-wider text-[#1D4ED8]">Datos Personales</h3>
                      </div>
                      <div className="grid grid-cols-2 gap-4">
                        <input placeholder="Nombre *" required className="bg-white border border-slate-200 rounded-xl px-4 py-2.5 text-sm outline-none focus:ring-2 ring-[#2563EB]/20" value={formData.nombre} onChange={e => setFormData({...formData, nombre: e.target.value})} />
                        <input placeholder="Apellido *" required className="bg-white border border-slate-200 rounded-xl px-4 py-2.5 text-sm outline-none focus:ring-2 ring-[#2563EB]/20" value={formData.apellido} onChange={e => setFormData({...formData, apellido: e.target.value})} />
              ...
              <div className="px-8 py-5 border-t border-slate-100 bg-slate-50/30 sticky bottom-0">
                <button
                  ...
                  className="w-full bg-[#2563EB] text-white py-3.5 rounded-xl font-black text-sm hover:bg-emerald-700 transition-all uppercase tracking-wider shadow-lg"
                >
                  {loadingForm
