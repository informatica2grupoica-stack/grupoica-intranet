    ...
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
          ...
          {productos.map((prod) => (
            ...
            >
              ...
              <Link
                ...
                className="inline-block mt-2 text-[8px] font-bold uppercase text-[#2563EB] hover:text-[#1D4ED8] transition-colors"
              >
                Ver producto →
              </Link>
            </div>
      ...
      {productos.length > 0 && (
        <Link
          ...
          className="block text-center mt-4 text-[9px] font-bold uppercase text-[#2563EB] hover:text-[#1D4ED8] transition-colors"
        >
