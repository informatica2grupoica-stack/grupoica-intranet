...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto pb-10">
      ...
      {/* ── Banner cabecera ─────────────────────────────────────────────── */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#111827] via-[#1F2937] to-[#111827] p-6 shadow-xl">
        ...
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl md:text-3xl font-black text-white mt-3 leading-tight">
              Dashboard de <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#10B981] to-[#34D399]">Análisis</span>
            </h1>
            {data && (
          ...
          <button onClick={actualizarDatos} disabled={refreshing}
            className="self-start md:self-center bg-gradient-to-r from-[#059669] to-[#10B981] hover:shadow-lg text-white px-5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wide flex items-center gap-2 transition-all active:scale-95 disabled:opacity-50">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Link href="/compras" className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-0.5 transition-all group">
          ...
          <div className="mt-2 flex items-center gap-1 text-[9px] text-[#059669] font-bold opacity-0 group-hover:opacity-100 transition-opacity">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/historial-precios" className="text-[9px] font-bold uppercase text-[#059669] hover:text-[#047857] flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              { href: "/obuma-productos", icon: Package, label: "Productos", desc: "Gestión de inventario", color: "text-[#059669]", bg: "bg-[#D1FAE5]" },
