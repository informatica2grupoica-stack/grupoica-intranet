...
async function obtenerDatosPorIntencion(intencion: string, pregunta: string, limit: number = 30) {
  ...
  try {
    switch (intencion) {
      ...
      default:
        // Estadísticas generales - con tipado correcto
        const stats: Record<string, number> = {};
        const tablas = ['productos_obuma', 'proveedores', 'tareas', 'perfiles', 'dispositivos', 'mensajes'];
...
4. Puedes consultar productos, proveedores, tareas, usuarios, dispositivos, mensajes
